...
if($tipo_publicidad == "contado"){
    if($descuento_publicidad=="0"){
        $query = "INSERT INTO publicidad VALUES (NULL , '$id_empresaPublicidad', '$publicidad_alta', '$publicidad_venc', '$num_publicidad', '$pag_seleccion', '$tam_banner', '$fec_alta_publicidad', '$fec_venc_publicidad', 'PUBLICIDAD', '$monto_publicidad', '1', '$cuota1_publicidad@$monto_publicidad', '$cuota2_publicidad@$monto2_publicidad', '$cuota3_publicidad@$monto3_publicidad', '$cuota4_publicidad@$monto4_publicidad', '$cuota5_publicidad@$monto5_publicidad', '$cuota6_publicidad@$monto6_publicidad', '$cuota7_publicidad@$monto7_publicidad', '$cuota8_publicidad@$monto8_publicidad', '$cuota9_publicidad@$monto9_publicidad', '$cuota10_publicidad@$monto10_publicidad', '$cuota11_publicidad@$monto11_publicidad', '$cuota12_publicidad@$monto12_publicidad','no','$inter_publicidad')";
    }
    if($descuento_publicidad!="0"){
        $query = "INSERT INTO publicidad VALUES (NULL , '$id_empresaPublicidad', '$publicidad_alta', '$publicidad_venc', '$num_publicidad', '$pag_seleccion', '$tam_banner', '$fec_alta_publicidad', '$fec_venc_publicidad', 'PUBLICIDAD', '$descto_publicidad', '1', '$cuota1_publicidad@$descto_publicidad', '$cuota2_publicidad@$monto2_publicidad', '$cuota3_publicidad@$monto3_publicidad', '$cuota4_publicidad@$monto4_publicidad', '$cuota5_publicidad@$monto5_publicidad', '$cuota6_publicidad@$monto6_publicidad', '$cuota7_publicidad@$monto7_publicidad', '$cuota8_publicidad@$monto8_publicidad', '$cuota9_publicidad@$monto9_publicidad', '$cuota10_publicidad@$monto10_publicidad', '$cuota11_publicidad@$monto11_publicidad', '$cuota12_publicidad@$monto12_publicidad','no','$inter_publicidad')";
    }
    if($hab_intercambio_publicidad == "on" && $por_intercambio_publicidad != "0"){
        $query = "INSERT INTO publicidad VALUES (NULL , '$id_empresaPublicidad', '$publicidad_alta', '$publicidad_venc', '$num_publicidad', '$pag_seleccion', '$tam_banner', '$fec_alta_publicidad', '$fec_venc_publicidad', 'PUBLICIDAD', '$por_pagar_publicidad', '1', '$cuota1_publicidad@$por_pagar_publicidad', '$cuota2_publicidad@$monto2_publicidad', '$cuota3_publicidad@$monto3_publicidad', '$cuota4_publicidad@$monto4_publicidad', '$cuota5_publicidad@$monto5_publicidad', '$cuota6_publicidad@$monto6_publicidad', '$cuota7_publicidad@$monto7_publicidad', '$cuota8_publicidad@$monto8_publicidad', '$cuota9_publicidad@$monto9_publicidad', '$cuota10_publicidad@$monto10_publicidad', '$cuota11_publicidad@$monto11_publicidad', '$cuota12_publicidad@$monto12_publicidad','si','$inter_publicidad')";
    }
}

if($tipo_publicidad == "igual"){
    if($hab_intercambio_publicidad == "on" && $por_intercambio_publicidad != "0"){
        $query = "INSERT INTO publicidad VALUES (NULL , '$id_empresaPublicidad', '$publicidad_alta', '$publicidad_venc', '$num_publicidad', '$pag_seleccion', '$tam_banner', '$fec_alta_publicidad', '$fec_venc_publicidad', 'PUBLICIDAD', '$por_pagar_publicidad', '$cuotas_publicidad', '$cuota1_publicidad@$monto1_publicidad', '$cuota2_publicidad@$monto2_publicidad', '$cuota3_publicidad@$monto3_publicidad', '$cuota4_publicidad@$monto4_publicidad', '$cuota5_publicidad@$monto5_publicidad', '$cuota6_publicidad@$monto6_publicidad', '$cuota7_publicidad@$monto7_publicidad', '$cuota8_publicidad@$monto8_publicidad', '$cuota9_publicidad@$monto9_publicidad', '$cuota10_publicidad@$monto10_publicidad', '$cuota11_publicidad@$monto11_publicidad', '$cuota12_publicidad@$monto12_publicidad','si','$inter_publicidad')";
    }else{
        $query = "INSERT INTO publicidad VALUES (NULL , '$id_empresaPublicidad', '$publicidad_alta', '$publicidad_venc', '$num_publicidad', '$pag_seleccion', '$tam_banner', '$fec_alta_publicidad', '$fec_venc_publicidad', 'PUBLICIDAD', '$monto_publicidad', '$cuotas_publicidad', '$cuota1_publicidad@$monto1_publicidad', '$cuota2_publicidad@$monto2_publicidad', '$cuota3_publicidad@$monto3_publicidad', '$cuota4_publicidad@$monto4_publicidad', '$cuota5_publicidad@$monto5_publicidad', '$cuota6_publicidad@$monto6_publicidad', '$cuota7_publicidad@$monto7_publicidad', '$cuota8_publicidad@$monto8_publicidad', '$cuota9_publicidad@$monto9_publicidad', '$cuota10_publicidad@$monto10_publicidad', '$cuota11_publicidad@$monto11_publicidad', '$cuota12_publicidad@$monto12_publicidad','no','$inter_publicidad')";
    }
}
